...
+ (NSArray<AKDevice *> * _Nullable)availableInputs SWIFT_WARN_UNUSED_RESULT;
/// Enumerate the list of available output devices.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<AKDevice *> * _Nullable inputs;)
+ (NSArray<AKDevice *> * _Nullable)inputs SWIFT_WARN_UNUSED_RESULT;
/// Enumerate the list of available output devices.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<AKDevice *> * _Nullable outputs;)
+ (NSArray<AKDevice *> * _Nullable)outputs SWIFT_WARN_UNUSED_RESULT;
